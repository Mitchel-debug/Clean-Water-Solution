# Generated by Django 4.0.4 on 2022-11-05 12:12
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cleanWater', '0007_alter_articles_date'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='cleanWater.user')),
            ],
        ),
    ]
